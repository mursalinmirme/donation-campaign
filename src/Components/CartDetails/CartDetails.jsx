...
const CartDetails = () => {
    ...
    return (
        <div className="max-w-[1350px] mx-auto pt-28 pb-20">
            <div className="h-[550px] relative rounded-lg overflow-hidden">
               <img className="w-full h-full" src={img} alt="" />
               <div className="bg-[#0b0b0b80] py-8 absolute bottom-0 w-full">
                <button onClick={handleDonateBtn} style={{background: `${text_color}`}} className="text-white px-8 ml-12 font-semibold text-base rounded-md py-3.5">Donate ${price}</button>
               </div>
            </div>
            <h2 className="text-3xl font-semibold mt-10">{title}</h2>
